...
Server-level instructions block in createApp(); plugin/codex manifests show the unscoped earthquake-mcp-server identity while install args stay scoped

## [0.1.13](changelog/0.1.x/0.1.13.md) — 2026-06-12

Adopt @cyanheads/mcp-ts-core ^0.10.6, explicit server identity in createApp(), MCPB bundle agent-doc stripping, Dockerfile healthcheck + version label
